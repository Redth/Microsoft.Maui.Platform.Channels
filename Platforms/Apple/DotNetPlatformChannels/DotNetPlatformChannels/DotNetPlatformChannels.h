...
FOUNDATION_EXPORT double DotNetPlatformChannelsVersionNumber;

//! Project version string for DotNetPlatformChannels.
FOUNDATION_EXPORT const unsigned char DotNetPlatformChannelsVersionString[];
